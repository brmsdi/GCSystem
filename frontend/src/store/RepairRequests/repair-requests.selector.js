export const selectAllRepairRequests = state => state.repairRequests;
export const selectCurrentPaginationTableRepairRequests = state => state.currentPaginationTableRepairRequests;
