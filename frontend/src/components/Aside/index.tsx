...
import { TEXT_MENU_ITEM_ID_CONDOMINIUM, TEXT_MENU_ITEM_ID_CONTRACT, TEXT_MENU_ITEM_ID_DEBT, TEXT_MENU_ITEM_ID_EMPLOYEE, TEXT_MENU_ITEM_ID_HOME, TEXT_MENU_ITEM_ID_LESSEE } from "utils/menu-items";
import { CONDOMINIUMS_HOME_URL, CONTRACTS_HOME_URL, DEBTS_HOME_URL, EMPLOYEES_HOME_URL, HOME_URL, LESSEES_HOME_URL } from "utils/urls";
