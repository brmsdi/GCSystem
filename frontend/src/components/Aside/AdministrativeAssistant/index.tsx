...
import { TEXT_MENU_ITEM_ID_CONDOMINIUM, TEXT_MENU_ITEM_ID_CONTRACT, TEXT_MENU_ITEM_ID_LESSEE, TEXT_MENU_ITEM_ID_ORDER_SERVICE, TEXT_MENU_ITEM_ID_REPAIR_REQUEST } from "utils/menu-items";
import { CONDOMINIUMS_HOME_URL, CONTRACTS_HOME_URL, LESSEES_HOME_URL, ORDER_SERVICE_HOME_URL, REPAIR_REQUESTS_HOME_URL } from "utils/urls";
import Aside from "..";
