...
import {
  detailsModalOrderService,
  selectOrderServiceTableAction,
  setStateFormOrderServiceAction,
  updateOrderServiceTableAction,
...
const ButtonMenuOrderServiceTable = (props: IProps) => {
  ...
  return (
    <ButtonDropDown
      ulID={`drop-menu-order-service-${props.item.id}`}
      itemsMenu={dropMenus}
    />
  );
};
