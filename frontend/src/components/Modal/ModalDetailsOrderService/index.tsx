...
const ModalDetailsOrderService = (props: IProps) => {
  ...
  const orderServiceSelectedFromModal: OrderService = useSelector(
    selectDetailsModalOrderService
  );
      ...
      <section className="modal-section">
        ...
        <div>
          ...
          <span
            className={
              "span-value " +
              statusColor(orderServiceSelectedFromModal.status.name)
            }
          >
            {orderServiceSelectedFromModal.status.name.toUpperCase()}
          </span>
        </div>
      </section>
