...
create table employee (id int4 generated by default as identity, birth_date timestamp, cpf varchar(255) not null, email varchar(255) not null, hiring_date timestamp, name varchar(255) not null, password varchar(255) not null, rg varchar(255) not null, fk_role_id int4, fk_status_id int4, primary key (id));
create table employee_specialty (employee_id int4 not null, specialty_id int4 not null, primary key (employee_id, specialty_id));
...
create table lessee (id int4 generated by default as identity, birth_date timestamp not null, contact_number varchar(255) not null, cpf varchar(255) not null, email varchar(255) not null, name varchar(255) not null, password varchar(255) not null, rg varchar(255) not null, fk_status_id int4, primary key (id));
create table localization (id int4 generated by default as identity, name varchar(255) not null, road varchar(255) not null, zip_code varchar(255) not null, primary key (id));
create table localization_condominium (id int4 generated by default as identity, number varchar(255) not null, fk_localization_id int4, primary key (id));
...
create table order_service (id int4 generated by default as identity, completation_date timestamp, generation_date timestamp not null, reserved_date timestamp not null, fk_status_id int4, primary key (id));
create table order_service_repair_requests (order_service_id int4 not null, repair_requests_id int4 not null, primary key (order_service_id, repair_requests_id));
...
create table repair_request (id int4 generated by default as identity, date timestamp not null, problem_description varchar(255) not null, fk_condominium_id int4, fk_lessee_id int4, fk_order_service int4, fk_status_id int4, fk_type_problem_id int4, primary key (id));
create table role (id int4 generated by default as identity, name varchar(255) not null, primary key (id));
create table specialty (id int4 generated by default as identity, name varchar(255) not null, primary key (id));
...
alter table if exists order_service_repair_requests add constraint UK_2t3k5hptomi6jhxg3qpyarrgx unique (repair_requests_id);
...
alter table if exists employee_specialty add constraint FKot0stmvnqgmjh90gxn0vf08ev foreign key (specialty_id) references specialty;
alter table if exists employee_specialty add constraint FKrp40g3rdd64j9nowt00r5yg34 foreign key (employee_id) references employee;
...
alter table if exists localization_condominium add constraint FKkbghwct6rai6l0aaw6q9781ch foreign key (fk_localization_id) references localization;
...
alter table if exists order_service_repair_requests add constraint FK36ftsclpiwo49sqg8vsq19erf foreign key (repair_requests_id) references repair_request;
alter table if exists order_service_repair_requests add constraint FK50jx46bi34nokaroa60npm0mk foreign key (order_service_id) references order_service;
