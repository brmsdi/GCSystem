...
public enum RoutesPrivate {
    ...
    URL_MOBILE_REPAIR_REQUEST(new RoutePrivate(API_V1_MOBILE.concat("/repair-requests/**"), new String[]{ROLE_ADMINISTRATOR, ROLE_ELECTRICIAN, ROLE_PLUMBER, ROLE_GENERAL_SERVICES}));
